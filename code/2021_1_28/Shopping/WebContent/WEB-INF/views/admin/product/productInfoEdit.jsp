...
<script
	...
	type="text/javascript"></script>
 <script
	src="${pageContext.request.contextPath}/resources/admin/js/ueditor/jquery.bootstrap-touchspin.js"></script>
</head>
...
<body class="blank">
											...
											<div class="row">
												<div class="form-group col-lg-6">
													<label>商品名称</label> <input id="id" name="id" type="hidden"
														value="${product.id}"> <input name="name"
														class="form-control" type="text" placeholder="商品名称"
														value="${product.name}">
												</div>
												<div class="form-group col-lg-6">
													<label>商品外部编号</label> <input name="externalId"
														class="form-control" type="text" placeholder="商品外部编号"
												...
												<div class="form-group col-lg-6">
													...
													<div>
														<label> <input type="radio" value="0"
															class="i-checks" name="inventoryFlag"
															<c:if test="${product.inventoryFlag==0}">checked</c:if>>&nbsp;&nbsp;是
														</label>&nbsp;&nbsp; <label> <input type="radio" value="1"
															class="i-checks" name="inventoryFlag"
															<c:if test="${product.inventoryFlag==1}">checked</c:if>>&nbsp;&nbsp;否
														</label>
													</div>
												</div>
												<div class="form-group col-lg-6">
													...
													<div>
														<label> <input type="radio" value="0"
															...
															<c:if test="${product.hot==0}">checked</c:if>>&nbsp;&nbsp;非热门商品
														</label>&nbsp;&nbsp; <label> <input type="radio" value="1"
															class="i-checks" name="hot"
															<c:if test="${product.hot==1}">checked</c:if>>&nbsp;&nbsp;热门商品
														</label>
													</div>
												</div>
											</div>
											<div class="row">
												<div class="form-group col-lg-6">
													<label>状态</label> <select name="productStatus"
														class="form-control">
														<option value="0"
															<c:if test="${product.productStatus==0}">selected</c:if>>上架</option>
														<option value="1"
															<c:if test="${product.productStatus==1}">selected</c:if>>下架</option>
													</select>
												</div>
												<div class="form-group col-lg-6">
													<label>商品概要说明</label> <input name="generalExplain"
														class="form-control" type="text" placeholder="商品概要说明"
														value="${product.generalExplain}">
												</div>
											</div>
											<div class="form-group col-lg-6">
												<label>上传图片</label>
	...
	$("#saveProductInfo").bind("click", function() {
		console.log($("#form_productInfo").valid()+"---->")
		//效验表单有没有值
