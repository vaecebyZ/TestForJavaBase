...
public class InvoiceApiController  extends AbstractApiController {
	...
	public ApiResponseObject getInvoice(@RequestBody Invoice invoice) {
		
		System.out.println("获取发票");
		
		
		return this.reponseJSON(ApiResponseEnum.SUCCESS.getCode(), ApiResponseEnum.SUCCESS.getName(),invoiceMapper.selectInvoice(invoice));
	}
	...
	public ApiResponseObject addInvoice(@RequestBody Invoice invoice) {
		...
		return this.reponseJSON(ApiResponseEnum.SUCCESS.getCode(), ApiResponseEnum.SUCCESS.getName(),invoiceMapper.insertInvoice(invoice));
	}
	...
	public ApiResponseObject editInvoice(@RequestBody Invoice invoice) {
		...
		return this.reponseJSON(ApiResponseEnum.SUCCESS.getCode(), ApiResponseEnum.SUCCESS.getName(),invoiceMapper.editInvoice(invoice));
	}
	...
	public ApiResponseObject delInvoice(@RequestBody Invoice invoice) {
		...
		return this.reponseJSON(ApiResponseEnum.SUCCESS.getCode(), ApiResponseEnum.SUCCESS.getName(),invoiceMapper.delInvoice(invoice));
	}
}
