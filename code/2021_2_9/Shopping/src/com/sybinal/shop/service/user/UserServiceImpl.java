...
public class UserServiceImpl implements UserService {
	...
	@Override
	public Map<String, Object> getUserjiFenInfoByCondition(PageInformation pageInfo, User user) {
		
		int pageCount = userMapper.selectCountByCondition(user);		
		List<User> listUser = pagingTool.PagingData("com.sybinal.shop.mapper.UserMapper.selectUserjiFenByCondition", user,
				(Integer.parseInt(pageInfo.getiDisplayStart())/Integer.parseInt(pageInfo.getiDisplayLength()) +1),Integer.parseInt(pageInfo.getiDisplayLength()));
