...
public class AccountApiController extends AbstractApiController {
	...
	@RequestMapping(value = "/account/getAccountInfo", method = RequestMethod.POST, headers = "Accept=application/json")
	public ApiResponseObject getUserBasic(@RequestBody User u) {
		System.out.println(u.getUserName());
		return reponseJSON(ApiResponseEnum.SUCCESS.getCode(),ApiResponseEnum.SUCCESS.getName(),accountService.selectAccountInfo(u.getUserName()));
	}
