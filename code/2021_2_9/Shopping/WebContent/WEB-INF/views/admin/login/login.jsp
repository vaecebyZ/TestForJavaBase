                ...
                <div class="panel-body">
                        <form class="form-signin" name='loginForm' action="<c:url value='/auth/login_check?targetUrl=${targetUrl}' />" method='POST'>
						     <div class="form-group">
                                ...
                                <input type="text" placeholder="用户名" title="请输入用户名" value="" name="username" id="username" class="form-control">
                            </div>
                            <div class="form-group">
                                <label class="control-label" for="password">密码</label>
                                <input type="password" title="请输入用户名" placeholder="******"  value="" name="password" id="password" class="form-control">
                            </div>
