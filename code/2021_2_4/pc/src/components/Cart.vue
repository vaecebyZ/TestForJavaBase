        ...
        <div class="row" v-else>
                ...
                <template>
                  <div class="item" v-for="product in cartList.productList">
                    ...
                    <div name="total_price" class="total_price">
                      ¥
                      <span>{{((product.shopPrice*product.quantity)/100).toFixed(2)}}</span>
                    </div>
                    <div class="qty">
                      <el-input-number
                        size="mini"
                      ...
                      ></el-input-number>
                      &times;
                      ¥ {{(product.shopPrice/100).toFixed(2)}}
                    </div>
          ...
          <div class="col-lg-3 col-sm-4">
            <div>
              <div class="hideDiv">
                <span class="clearfix">
                  <span id="sumCart" class="pull-right">¥ {{(cartList.price/100).toFixed(2)}}</span>
                ...
                <hr>
                <span class="clearfix">
                  <span class="pull-right size-20">¥{{(cartList.price/100).toFixed(2)}}</span>
