...
public class UserController {
	...
	@RequestMapping(value = "/admin/userjiFenInfoDataTable", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> userjiFenInfoDataTable(PageInformation pageInfo, User user) {
		return userService.getUserjiFenInfoByCondition(pageInfo, user);
	}
