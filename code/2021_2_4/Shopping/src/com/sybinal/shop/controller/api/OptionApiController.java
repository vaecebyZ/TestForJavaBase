...
public class OptionApiController extends AbstractApiController {
	...
	@RequestMapping(value = "catalog/product/option/details/{productId}", method = RequestMethod.GET, headers = "Accept=application/json")
	public ApiResponseObject getOptionDetails(@PathVariable("productId") int productId) {
