...
public class ArticleController {
	...
	public ModelAndView receiveUpdateArticle(@RequestParam("id") Integer id){
	...
	@RequestMapping(value = "/admin/receiveUpdateArticle2")
	public ModelAndView receiveUpdateArticle2(@RequestParam("id") Integer id){
		  Map<String,Object> data = new HashMap<String,Object>();
		  Article model=articleService.getArticleById(id);
		  data.put("model",model); 
		  return new ModelAndView("admin/article/articleadd",data);
